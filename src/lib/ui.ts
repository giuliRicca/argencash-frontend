export const ui = {
  ...
  panel: "rounded-[var(--radius-panel)] border border-[var(--border-soft)] bg-[var(--surface-1)] p-6 shadow-[var(--shadow-panel)] sm:p-8",
  heroPanel: "flex flex-col gap-4 rounded-[var(--radius-panel)] border border-[var(--border-soft)] bg-[var(--bg-hero-gradient)] p-6 shadow-[var(--shadow-hero)] sm:flex-row sm:items-start sm:justify-between sm:p-8",
  tile: "rounded-3xl border border-[var(--border-muted)] bg-[var(--surface-2)] p-5",

  textMuted: "text-[var(--text-muted)]",
  textPrimary: "text-[var(--text-primary)]",

  input: "rounded-2xl border border-[var(--border-strong)] bg-[var(--surface-2)] px-4 py-3 text-[var(--text-primary)] outline-none",
  select: "rounded-2xl border border-[var(--border-strong)] bg-[var(--surface-2)] px-3 py-2 text-sm text-[var(--text-primary)] outline-none",

  buttonBase: "rounded-2xl px-4 py-2 font-medium transition disabled:cursor-not-allowed disabled:opacity-70",
